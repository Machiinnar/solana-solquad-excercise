...
pub mod solquad {
    ...
    pub fn distribute_escrow_amount(ctx: Context<DistributeEscrowAmount>) -> Result<()> {
        ...
        // added a total_distributable_amt to accumulate the distributable amounts for all projects.
        ...
        for i in 0..escrow_account.project_reciever_addresses.len() {
            ...
            // it is important to use checked arithmetic to handle potential overflows
            if votes != 0 {
